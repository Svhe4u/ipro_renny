...
export default function MyCvsPage() {
  ...
  if (loading) {
    return <div className="flex items-center justify-center h-screen text-white">Loading your CVs...</div>;
  }
  ...
  return (
    <div className="p-6 space-y-6">
      <h1 className="text-3xl font-bold text-white">Your CVs</h1>
      <Card className="bg-gray-800/80 backdrop-blur-md border border-gray-700">
        <CardHeader>
          <CardTitle className="text-2xl text-white">Your Saved CVs</CardTitle>
        </CardHeader>
